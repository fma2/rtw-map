...
function main() {
    ...
    cartodb.createLayer(map,'https://fma2.cartodb.com/api/v2/viz/8c2ba0e6-faa2-11e5-bc96-0e31c9be1b51/viz.json')
    .addTo(map)
    .done(function(layer){
      var subLayer = layer.getSubLayer(0);
      ...
      // create selector for this layer
      createSelector(subLayer, '#layer_selector li.min-wage', 'us_states_with_ak_hi_carto_db_rtw_assets_opp_with_geo', 'min_wage');
    })  
  })
	.error(function(err) {
		console.log(err);
